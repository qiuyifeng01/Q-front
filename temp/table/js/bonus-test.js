$.fn.bonus=function(opts,callback){
	var defaults={
	...
	bonus[i]=$('<div class="bonus" bonusID='+setter.bonusID+' style="z-index:900;position: absolute;left: 0;width: 100px;cursor:pointer; -webkit-user-select:none; "><img src="./images/hb1.png" style="width:100%;"></div>');
	$(this).append(bonus[i]);
	...
	function changePos(obj){
		...
		console.log('height - Hoffset = '+(parseInt(height) - parseInt(Hoffset)));
		if (setter.yon)
		...
		if (setter.yPos >= (parseInt(height) - parseInt(Hoffset)))
